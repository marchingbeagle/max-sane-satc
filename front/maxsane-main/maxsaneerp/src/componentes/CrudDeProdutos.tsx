    ...
    <div className="p-4">
      {view === View.LIST && (
        <div>
          ...
          <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={handleCreateProduct}>
            Novo Produto
          </button>
          <ul className="mt-4">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-gray-200 p-4 flex justify-center">
        ...
        {showDetails && (
          <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={handleCloseDetails}>
            Voltar para a lista
          </button>
        )}
      </div>
